 ...
 */
declare let get91pornList: (
  params: Get91PornListParams,
) => Get91PornListReturnType | null | Promise<Get91PornListReturnType | null>;
//#endregion 91porn.list

//#region loadResource
/** Params of 加载资源 */
interface LoadResourceParams extends Nsfw91Porn.GlobalParams, BaseParams {}

/** Return Type of 加载资源 */
interface LoadResourceReturnType extends Array<StreamSourceItem> {}

/** 加载资源 */
declare let loadResource: (
  params: LoadResourceParams,
) => LoadResourceReturnType | null | Promise<LoadResourceReturnType | null>;
 ...
 */
declare let getNewList: (
  params: GetNewListParams,
) => GetNewListReturnType | null | Promise<GetNewListReturnType | null>;
 ...
 */
declare let getChannelList: (
  params: GetChannelListParams,
) => GetChannelListReturnType | null | Promise<GetChannelListReturnType | null>;
 ...
 */
declare let getPornstarsList: (
  params: GetPornstarsListParams,
) => GetPornstarsListReturnType | null | Promise<GetPornstarsListReturnType | null>;
